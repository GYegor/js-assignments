...
function encodeToRot13(str) { 
    let initCharset = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
    let rotThirteenCharset = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';
    return str.split('').map(char => char.match(/[A-Z]/i)?rotThirteenCharset.charAt(initCharset.indexOf(char)):char).join('');
}
