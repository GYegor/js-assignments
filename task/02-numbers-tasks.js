...
function getAverage(value1, value2) {
    return value1 + value2 == 0 ? 0 : Number.isFinite(value1 + value2) ? (value1 + value2) / 2 : Number.MAX_VALUE;
}
...
function toNumber(value, def) {
    return Number.isInteger(Number.parseInt(value)) ? Number.parseInt(value) : arguments[1];
}
